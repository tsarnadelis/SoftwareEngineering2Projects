...
//ταυτίζονται με τα "παλιά" δεδομένα της θέσης.
//Δηλαδή, τεστάρω αν όντως έγινε τροποποίηση των δεδομένων της θέσης.
test("POST /spot 400 for taking the same spot after modificaton", async (t) => {
    //Το test αποτυχαίνει δίοτι τα τροποποιημένα δεδομένα ταυτίζονται με τα ήδη υπάρχοντα δεδομένα της θέσης.
